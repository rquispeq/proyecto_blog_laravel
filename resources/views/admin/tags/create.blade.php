    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Creación de Tag</h3>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="custom-control custom-radio">
                                <input class="custom-control-input @error('active') is-invalid @enderror" type="radio" id="radio1" value="0" name="active">
                                <label for="radio1" class="custom-control-label">Inactivo</label>
                            </div>

                            <div class="custom-control custom-radio">
                                <input class="custom-control-input @error('active') is-invalid @enderror" type="radio" id="radio2" value="1" name="active" checked>
